...
public class RemoteBlazeEntity extends EntityBlaze implements RemoteEntityHandle
{
	...
	private PathfinderGoalHurtByTarget m_attackTarget;
	...
	public RemoteBlazeEntity(World world, RemoteEntity inRemoteEntity)
	{
		...
		this.m_attackTarget = new PathfinderGoalHurtByTarget(this, false);
	}
	...
	public void h_()
	{
		...
		if(this.m_attackTarget.a())
			this.m_attackTarget.e();
	}
