...
public class DefaultEntitySpeed
{
	...
	public static final float SPIDER_SPEED = 0.2F;
	...
	public static final float IRONGOLEM_SPEED = 0.15F;
	...
	public static final float OCELOTE_SPEED = 0.23F;
	public static final float PIG_SPEED = 0.27F;
	public static final float ZOMBIE_SPEED = 0.2F;
	...
	public static final float WOLF_SPEED = 0.23F;
	public static final float SKELETON_SPEED = 0.2F;
}
